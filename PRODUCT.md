...
- Current complete workflows cover TestFlight builds and group assignment; the unified Releases workbench for version, build, all six localized fields, screenshots, exact-diff review, readiness, submission, and status; assisted translation and keyword adaptation; app-scoped written customer reviews, grounded reply drafting, and guarded public responses; portfolio-to-app App Analytics; multiple App Store Connect accounts; and Apple Ads research, reporting, and guarded campaign management.
...
- Direct IPA/PKG upload, monetization, distribution, activity, additional submission controls, version-scoped review browsing, aggregate storefront ratings, review-response deletion, deeper analytics cohorts/reconciliation, scheduled analytics sync, and analytics AI explanations remain future work.
